...
export async function fetchCars(filters: FilterProps) {
    ...
    const response = await fetch(`https://cars-by-api-ninjas.p.rapidapi.com/v1/cars?model=${model}&fuel_type=${fuel}&limit=${limit}&year=${year}&make=${manufacturer}`, {headers: headers});
